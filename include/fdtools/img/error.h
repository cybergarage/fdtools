...
#define FDT_IMAGE_MESSAGE_SECTORS_NOT_SORTED "Sectors are not sorted: %s"
#define FDT_IMAGE_MESSAGE_SECTOR_NOT_FOUND "Sector is not found: " FDT_IMAGE_MESSAGE_SECTOR_PRINTF_FORMAT
...
#define FDT_IMAGE_MESSAGE_EXPORTER_NOT_SUPPORTED "%s : Exporter is not supported"
