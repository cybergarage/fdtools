...
#define fdt_image_setnumberoftrack(img, v) fdt_image_config_setnumberoftrack(img->config, v)
...
#define fdt_image_getnumberoftrack(img) fdt_image_config_getnumberoftrack(img->config)
